...
#' @export
#' 
return_loss_importance <- function (id, serve.prob, return.prob, bestof3 = TRUE, advantage = TRUE) 
{
...
return_loss_importance <- Vectorize(return_loss_importance)
