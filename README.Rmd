...
For users interested in updating or running their own player Elo ratings, I would recommend looking at the Rcpp implementation of [martiningram](https://github.com/martiningram), which you can find [here](https://github.com/martiningram/tennisratingscpp).
